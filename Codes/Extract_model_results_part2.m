...
% This code extract the outputs from 10 models : Kg x50, Kg x8, Kf x0.08,
% Kf x 0.5, l = 2, No ice, T0 + 1°C, T0 - 1°C, Precipitation rate x0.9, and
% Precipitation rate x 1.25.

% The results are saved in .mat files to be used by the matlab codes
% 'plot_figures_part2.m' and 'Merge_results.m'
...
Legend_Models = {'K_Gx50';'K_Gx8';'K_Fx0.5';'K_Fx0.08';'l = 2';'No ice';...
...
save([path_to_save_analyses,'Models_results_part2.mat'],'Total_LRS_area','Erosion_models', 'ELA_array','std_ELA_array', ...
...
save([path_to_save_analyses,'Erosion_timeSeries_part2.mat'],'Mean_erosion_rate_evolution','Mean_glacial_rate_evolution','Mean_fluvial_rate_evolution', ...
...
cd(path_to_codes)
save([path_to_save_analyses,'LRS_area_evolution_part2.mat'],'LRS_area_evolution','LRS_area_distribution_stage1')
...
save([path_to_save_analyses,'Glacial_interglacials_part2.mat'],'delta_max_Temp_array','Mean_Temp_interglacials','Mean_Erate_interglacials')
...
% Save data
save([path_to_save_analyses,'Erosion_vs_elevation_part2.mat'],'Erosion_dist','bed_dist')
...
save([path_to_save_analyses,'Relief_scales_part2.mat'],'mean_erosion','mean_local_relief','mean_large_relief_init','mean_local_relief_init','mean_large_relief')
