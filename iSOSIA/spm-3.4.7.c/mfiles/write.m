...
fprintf(fid,'%d\n',SPM.mesh.dosubdeformation);
fprintf(fid,'%d\n',SPM.mesh.doparticles);
fprintf(fid,'%d\n',SPM.mesh.dodeposit);
fprintf(fid,'%d\n',SPM.mesh.dodebrisablation);
fprintf(fid,'%d\n',SPM.mesh.douniformerosion);
fprintf(fid,'%d\n',SPM.mesh.dopulse);
fprintf(fid,'%d\n',SPM.mesh.Flaw); %Maxime
fprintf(fid,'%d\n',SPM.mesh.gelaw); %Maxime
fprintf(fid,'%d\n',SPM.mesh.steadybed); %Maxime
fprintf(fid,'%d\n',SPM.mesh.nbCores); %Maxime
fclose(fid);
...
fwrite(fid,SPM.mprop.scc,'double');
...
fwrite(fid,SPM.hwprop.dss,'double');
fclose(fid);
...
fwrite(fid,SPM.hprop.kt,'double');
fclose(fid);
...
fwrite(fid,SPM.fprop.m,'double'); %Maxime
fwrite(fid,SPM.fprop.t_sp,'int'); %Maxime
fclose(fid);
...
fwrite(fid,SPM.data.isostasy,'double');
fwrite(fid,SPM.data.abrasion,'double');
fwrite(fid,SPM.data.fluvial,'double');
fwrite(fid,SPM.data.hillslope,'double');
fclose(fid);
