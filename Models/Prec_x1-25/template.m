...
%****** ice properties *************
SPM.iprop.ifac = 0.005;       %Relaxation constant (velocity)
SPM.iprop.sfac = 0.005;        %Relaxation constant (stress)
...
SPM.mprop.maxacc =1.25;  %maximum accumulation rate
...
SPM.data.precip = ones(size(SPM.data.bed)).*1.25;
